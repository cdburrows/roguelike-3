...
public interface IDungeon {
    ...
    /**
     * Adds a one-way unconditional edge between the given rooms. A one-way edge
     * may be used to travel from room1 to room2, but not room2 to room1.
     * 
    ...
    /**
     * Adds a two-way unconditional edge between the given rooms. A two-way edge
     * may be used to travel from each room to the other.
     * 
     * @param room1 the first room to link
     * @param room2 the second room to link
     */
    ...
    /**
     * Adds a one-way conditional edge between the given rooms. A one-way edge
     * may be used to travel from room1 to room2, but not room2 to room1.
     * 
     * @param room1 the first room to link
     * @param room2 the second room to link
    ...
    /**
     * Adds a two-way conditional edge between the given rooms. A two-way edge
     * may be used to travel from each room to the other.
     * 
     * @param room1 the first room to link
     * @param room2 the second room to link
